...
$euphoric_plus = class_exists('Euphoric_Pro_Client');
$freeware_plus = class_exists('Freeware_Pro_Client');
$otography_plus = class_exists('Otography_Pro_Client');
$freenews_plus = class_exists('Freenews_Pro_Client');
$timesnews_plus = is_plugin_active('timesnews-pro/timesnews-pro.php') ? '1' : '';
$businessdeal_plus = class_exists('Businessdeal_Pro_Client');
